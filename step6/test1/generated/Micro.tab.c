...
{
       0,   102,   102,   139,   141,   143,   175,   228,   235,   245,
     247,   262,   263,   265,   266,   269,   285,   300,   306,   313,
     317,   326,   326,   328,   328,   330,   374,   389,   393,   398,
     400,   402,   406,   408,   410,   412,   416,   428,   443,   464,
     485,   489,   504,   522,   526,   540,   557,   561,   563,   566,
     568,   568,   570,   570,   572,   582,   587,   594,   608,   610,
     613,   615,   618,   657,   685,   688,   698,   700,   702,   704,
     706,   708,   712,   717,   724,   729,   736,   785
};
#endif
	...
	if (scope == 0){
		...
		if(!currfief.empty()){
			...
			*newfief = currfief;	
			...
			currfief.clear();
			//cout << $<fief>$ << endl;	
			//cout << (*((list<string>*)$<fief>$)).size() << endl;
			//cout << "Finished decl" << endl;
		}
		else if ((yyvsp[(2) - (2)].fief) != 0){
			(yyval.fief) = (yyvsp[(2) - (2)].fief);
		}
