...
{
       0,    66,    66,    97,   101,   103,   135,   180,   186,   193,
     196,   211,   215,   219,   220,   222,   238,   256,   262,   269,
     272,   280,   280,   283,   283,   285,   319,   328,   328,   330,
     331,   332,   334,   334,   334,   334,   337,   339,   341,   343,
     345,   348,   350,   350,   352,   354,   354,   356,   356,   358,
     360,   360,   362,   362,   364,   364,   364,   364,   366,   368,
     371,   390,   412,   414,   416,   419,   419,   421,   421,   424,
     444
};
#endif
...
#line 286 "experimental/Micro.y"
	...
	if ((yyvsp[(5) - (9)].fief) != 0){	
		(*newkingdom).push((vector<string>*)(yyvsp[(5) - (9)].fief));
	}
...
/* Line 1455 of yacc.c  */
#line 319 "experimental/Micro.y"
    {
	if((yyvsp[(1) - (2)].fief) != 0){	
		if(!(*((vector<string>*)(yyvsp[(1) - (2)].fief))).empty()){
			currkingdom.push((vector<string>*)(yyvsp[(1) - (2)].fief));
		}
	}
;}
    break;
...
/* Line 1455 of yacc.c  */
#line 395 "experimental/Micro.y"
    {
	if((yyvsp[(2) - (3)].fief) != 0){	
		string s1("Symbol table ELSE");
		//fief has to be void in order to be transferrable in C union
		vector<string> *vectorptr = (vector<string>*)(yyvsp[(2) - (3)].fief);	
		(*vectorptr).insert((*vectorptr).begin(),s1);
		if(!(*vectorptr).empty()){
			currkingdom.push(vectorptr);
		}
...
/* Line 1455 of yacc.c  */
#line 425 "experimental/Micro.y"
    {
	if((yyvsp[(9) - (11)].fief) != 0){		
		string s1("Symbol table FOR");	
		//fief has to be void in order to be transferrable in C union
		vector<string> *vectorptr = (vector<string>*)(yyvsp[(9) - (11)].fief);	
		(*vectorptr).insert((*vectorptr).begin(),s1);
		if(!(*vectorptr).empty()){
			currkingdom.push(vectorptr);
		}
